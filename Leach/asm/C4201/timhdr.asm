...
; Port D equates
SLAVE	EQU	0		; Set if master by not installing a jumper
...
ST_SYNC EQU     13      ; Set if synchronizing two controllers
ST_CNRD	EQU	14	; Set if in continous readout mode
ST_SA   EQU     16      ;  copied in for roi 3/16/2011 r.a.
...
IRX8VP		EQU	$000005		; 8 X IR Video Processor
