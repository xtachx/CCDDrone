        ...
        std::string OutFileName)
{
    ...
    if (ExposeStrategy == 1) {
        /*Debugging info*/
        std::string ExposeStrategyTxt = "Strategy: 1 (single readout)";
        ExposeStrategyTxt = ColouredFmtText(ExposeStrategy, "magenta");
        ExposeStrategyTxt += " | The image will be read all at once.\n";
        std::cout << ExposeStrategyTxt;
        ...
        /*Debugging info*/
        std::string ExposeStrategyTxt = "Strategy: 2 (segmented readout)";
