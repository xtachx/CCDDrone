...
#ifdef WIN32
	#ifdef DLLFITSFILE_EXPORTS
		#define DLLFITSFILE_API __declspec( dllexport )
	#else
		#define DLLFITSFILE_API __declspec( dllimport )
	#endif
#else
	#define DLLFITSFILE_API __attribute__((visibility("default")))
#endif
